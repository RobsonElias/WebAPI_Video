...
namespace WebAPI_Video.Service.FuncionarioService
{
    public class FuncionarioService : IFuncionarioInterface
    {
        ...
        [HttpDelete]
        public async Task<ServiceResponse<List<FuncionarioModel>>> DeleteFuncioario(int id)
        {
            ServiceResponse<List<FuncionarioModel>> serviceResponse = new ServiceResponse<List<FuncionarioModel>>();
        ...
        public async Task<ServiceResponse<FuncionarioModel>> GetFuncioarioById(int id)
        {
        ...
        public async Task<ServiceResponse<List<FuncionarioModel>>> GetFuncioarios()
        {
            ServiceResponse<List<FuncionarioModel>> serviceResponse = new ServiceResponse<List<FuncionarioModel>>();
        ...
        public async Task<ServiceResponse<List<FuncionarioModel>>> InativaFuncioario(int id)
        {
            ServiceResponse<List<FuncionarioModel>> serviceResponse = new ServiceResponse<List<FuncionarioModel>>();
        ...
        [HttpPut]
        public async Task<ServiceResponse<List<FuncionarioModel>>> UpdateFuncioario(FuncionarioModel editadoFuncionario)
        {
            ServiceResponse<List<FuncionarioModel>> serviceResponse = new ServiceResponse<List<FuncionarioModel>>();
